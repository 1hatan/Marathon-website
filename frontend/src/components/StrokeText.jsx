...
const StrokeText = ({
  ...
  const getStrokeColor = (char, index) =>
    typeof strokeColor === 'function' ? strokeColor(char, index) : strokeColor;

  const getFillColor = (char, index) =>
    typeof fillColor === 'function' ? fillColor(char, index) : fillColor;
        ...
        >
          {characters.map((char, index) => (
            <tspan
              data-stroke-char
              key={`s-${index}`}
              stroke={getStrokeColor(char, index)}
            >
              {char}
            </tspan>
          ))}
